...
export default function ProductCard({ product }: ProductCardProps) {
    ...
    return (
        ...
        >
            ...
            <meta itemProp="description" content={product.short_description || product.name} />

            {product.primary_image && (
                <link itemProp="image" href={product.primary_image} />
            )}
            ...
            <div itemProp="offers" itemScope itemType="https://schema.org/Offer">
                ...
                <link
                    ...
                    href={product.stock_quantity > 0 ? 'https://schema.org/InStock' : 'https://schema.org/OutOfStock'}
                />
                <meta itemProp="seller" content="Yến Sào Hòn Nội" />
            </div>

            <Link
                href={`/san-pham/${product.slug}`}
                className="block card overflow-hidden cursor-pointer"
                itemProp="url"
            >
