...
export default async function ProductDetailPage({ params }: PageProps) {
    ...
    const productImage = product.images?.[0]?.url || `${siteUrl}/og-image.jpg`;
    ...
    const breadcrumbSchema = generateBreadcrumbSchema([
        ...
        ...(product.category ? [{ name: product.category.name, url: `${siteUrl}/san-pham?category=${product.category.slug}` }] : []),
